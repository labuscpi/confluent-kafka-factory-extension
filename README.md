...
* Package Manager
```
Install-Package Confluent.Kafka.FactoryExtensions -Version 8.0.x
```

* .NET CLI
```
dotnet add package Confluent.Kafka.FactoryExtensions --version 8.0.x
```

* PackageReference
```
<PackageReference Include="Confluent.Kafka.FactoryExtensions" Version="8.0.x" />
```
