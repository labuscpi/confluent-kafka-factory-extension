...
* Package Manager
```
Install-Package Confluent.Kafka.FactoryExtension -Version 6.0.0
```

* .NET CLI
```
dotnet add package Confluent.Kafka.FactoryExtension --version 6.0.0
```

* PackageReference
```
<PackageReference Include="Confluent.Kafka.FactoryExtension" Version="6.0.0" />
```
